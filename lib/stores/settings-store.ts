...
export const useSettingsStore = create<SettingsState>()(
  persist(
    ...
    {
      name: "conjugate-fitness-settings-state",
      partialize: (state) => ({
...
export const useSetBarWeight = () =>
  useSettingsStore((state) => state.setBarWeight);
export const useSelectedPlates = () =>
  useSettingsStore((state) => state.selectedPlates);
export const useTogglePlate = () =>
  useSettingsStore((state) => state.togglePlate);
export const usePlateQuantities = () =>
  useSettingsStore((state) => state.plateQuantities);
export const useSetPlateQuantity = () =>
  useSettingsStore((state) => state.setPlateQuantity);
