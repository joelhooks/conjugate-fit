...
export const percentageBasedProgression: ProgressionScheme = {
  ...
  description:
    "Standard Westside Barbell progression for max effort lifts, based on percentage of target weight.",
...
export const wendler531Progression: ProgressionScheme = {
  ...
  description:
    "Jim Wendler's 5/3/1 progression for main lifts, based on training max (90% of 1RM).",
...
export const texasMethodProgression: ProgressionScheme = {
  ...
  description:
    "Weekly progression with volume day (Monday), recovery day (Wednesday), and intensity day (Friday).",
  ...
  progressionSteps: [
    {
      ...
      setNumber: 1,
      percentage: 90,
      notes: "Monday: Volume Day - Set 1 of 5x5",
    },
    {
      step: 2,
      setNumber: 2,
      percentage: 90,
      notes: "Monday: Volume Day - Set 2 of 5x5",
    },
    {
      step: 3,
      setNumber: 3,
      percentage: 90,
      notes: "Monday: Volume Day - Set 3 of 5x5",
    },
    {
      step: 4,
      setNumber: 4,
      percentage: 90,
      notes: "Monday: Volume Day - Set 4 of 5x5",
    },
    {
      step: 5,
      setNumber: 5,
      percentage: 90,
      notes: "Monday: Volume Day - Set 5 of 5x5",
    },
    {
      step: 6,
      setNumber: 6,
      percentage: 80,
      notes: "Wednesday: Recovery Day - 2x5",
    },
    {
      step: 7,
      setNumber: 7,
    ...
    },
    {
      ...
      setNumber: 8,
      percentage: 100,
      notes: "Friday: Intensity Day - New 5RM",
    },
  ],
};
  ...
  progressionSteps: [
    {
      ...
      setNumber: 1,
      percentage: 70,
      notes: "Week 1, Day 1: Set 1 of 6x6",
    },
    {
      step: 2,
      setNumber: 2,
      percentage: 70,
      notes: "Week 1, Day 1: Set 2 of 6x6",
    },
    {
      step: 3,
      setNumber: 3,
      percentage: 70,
      notes: "Week 1, Day 1: Set 3 of 6x6",
    },
    {
      step: 4,
      setNumber: 4,
      percentage: 70,
      notes: "Week 1, Day 1: Set 4 of 6x6",
    },
    {
      step: 5,
      setNumber: 5,
      percentage: 70,
      notes: "Week 1, Day 1: Set 5 of 6x6",
    },
    {
      step: 6,
      setNumber: 6,
      percentage: 70,
      notes: "Week 1, Day 1: Set 6 of 6x6",
    },
    {
      step: 7,
      setNumber: 7,
      percentage: 75,
      notes: "Week 1, Day 2: Set 1 of 7x5",
    },
    {
      step: 8,
      setNumber: 8,
      percentage: 75,
      notes: "Week 1, Day 2: Set 2 of 7x5",
    },
    {
      step: 9,
      setNumber: 9,
      percentage: 75,
      notes: "Week 1, Day 2: Set 3 of 7x5",
    },
    {
      step: 10,
      setNumber: 10,
      percentage: 75,
      notes: "Week 1, Day 2: Set 4 of 7x5",
    },
    {
      step: 11,
      setNumber: 11,
      percentage: 75,
      notes: "Week 1, Day 2: Set 5 of 7x5",
    },
    {
      step: 12,
      setNumber: 12,
      percentage: 75,
      notes: "Week 1, Day 2: Set 6 of 7x5",
    },
    {
      step: 13,
      setNumber: 13,
      percentage: 75,
      notes: "Week 1, Day 2: Set 7 of 7x5",
    },
  ],
};
...
export function calculateProgressionWeights(
  ...
  try {
    ...
    const steps = Array.isArray(scheme.progressionSteps)
      ? scheme.progressionSteps
      : [];
...
export function isMaxEffortExercise(title: string, setsCount: number): boolean {
  try {
    ...
    const isMainLift = maxEffortKeywords.some((keyword) =>
      safeTitle.toLowerCase().includes(keyword),
    );
    ...
    console.error("Error determining if exercise is max effort:", error);
    return false;
  }
}
